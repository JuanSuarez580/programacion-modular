...
FinFuncion
Funcion dato_precioproducto<-hallar_precios
	dato_precioproducto<-sacar_total
FinFuncion

Funcion mensaje_precio<-crear_mensaje_precio
	mensaje_precio<-"El total del precio de los productos es: "+ConvertirATexto(hallar_precios)
FinFuncion
Funcion mostrar_precio
	Escribir crear_mensaje_precio
FinFuncion
Funcion dato_iva<-agregar_iva
	dato_precio1<-hallar_precios
	dato_iva<-dato_precio1*0.19
	dato_iva<-dato_precio1+dato_iva
FinFuncion
